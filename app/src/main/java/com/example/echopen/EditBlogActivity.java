...
public class EditBlogActivity extends AppCompatActivity {
    ...
    private void updateDataInFirebase(BlogItemModel blogItemModel) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance("https://blog-app-9a56d-default-rtdb.asia-southeast1.firebasedatabase.app").getReference("blogs");
