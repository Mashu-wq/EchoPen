...
public class SavedArticlesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userId != null) {
            DatabaseReference userReference = FirebaseDatabase.getInstance("https://blog-app-9a56d-default-rtdb.asia-southeast1.firebasedatabase.app")
    ...
    private BlogItemModel fetchBlogItem(String postId) {
        DatabaseReference blogReference = FirebaseDatabase.getInstance("https://blog-app-9a56d-default-rtdb.asia-southeast1.firebasedatabase.app")
                .getReference("blogs");
        try {
